 ...
 */
public abstract class UserIdentityPwdAndSecurityQuestionSetBaseActivity extends BaseTitleBarActivity {
    ...
    private void submit() {
        ...
        this.submitForm(identityPwd, securityQuestionAnswers);
    }
     ...
     */
    protected abstract void submitForm(@NonNull String identityPwd, @NonNull LinkedHashMap<Long, String> securityQuestionAnswers);
